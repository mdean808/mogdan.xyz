    ...
    <div :class="{dark: darkMode}">
        <nav
            ...
            <div class="flex flex-row justify-center">
                <router-link to="/" class="text-white dark:text-gray-100"><h3 class="dark:text-gray-100">Morgan
                    Dean</h3></router-link>
            </div>

            <ul class="flex flex-col text-center mx-auto mt-3">
                <li class="p-2">
                    <router-link to="/projects" class="text-white dark:text-gray-100">projects</router-link>
                </li>
                <li class="p-2">
                    <router-link to="/resume" class="text-white dark:text-gray-100">resume</router-link>
                </li>
                <li class="p-2">
                    <a href="https://repo.mogdan.xyz" target="_blank" class="text-white dark:text-gray-100">jailbreak
                        repository</a>
                </li>
            </ul>
            <div class="fixed bottom-6 left-0 w-1/6">
                <div class="text-center mx-auto w-full">
                    <a href="mailto:morgan@mogdan.xyz" target="_blank" class="block text-white dark:text-gray-100">morgan@mogdan.xyz</a>
                    <a href="tel:+18086401099" class="block text-white dark:text-gray-100">1 (808) 640-1099</a>
                </div>
            </div>
        </nav>
        <div class="bg-white dark:bg-gray-600 pt-4 px-2 h-full w-5/6 absolute top-0 left-1/6 overflow-x-hidden transition duration-150">
            ...
            <div class="fixed left-1/6 w-5/6 bottom-0 py-2 px-2">
                <p class="float-left dark:text-white">© 2021 Morgan Dean</p>
        ...
        <div class="absolute right-1 top-1 hover:bg-gray-700 dark:hover:bg-white dark:hover:text-gray-700 hover:text-white text-gray-700 dark:text-white border-gray-700 dark:border-white border-2 rounded-md cursor-pointer transition duration-150" @click="changeDarkMode">
            <svg v-if="!darkMode" class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20"
