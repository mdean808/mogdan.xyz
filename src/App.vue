<template>
    <div :class="{ dark: darkMode }">
        ...
        >
            ...
            <div
                class="lg:block hidden rotate-90 h-20 w-20 bg-no-repeat rounded-full bg-center bg-cover mx-auto"
                style="background-image: url('/img/me.jpg')"
            ></div>
            <div class="lg:block hidden flex flex-row justify-center">
                <router-link
                    ...
                    ><h3 class="dark:text-gray-100 transition duration-150">
                        Morgan Dean
                    </h3></router-link
                >
            </div>
            ...
            <div class="lg:block hidden fixed bottom-6 left-0 w-1/6">
                <div class="text-center mx-auto w-full">
                    <a
                        ...
                        target="_blank"
                        class="block text-white dark:text-gray-100 transition duration-150"
                        >morgan@mogdan.xyz</a
                    >
                    <a
                        href="tel:+18086401099"
                        class="block text-white dark:text-gray-100 transition duration-150"
                        >1 (808) 640-1099</a
                    >
                </div>
        ...
        <transition name="slide">
            ...
            >
                <div class=" py-2 w-2/3 bg-purple-400 dark:bg-purple-500 transition duration-150">
                    <div
                        class="rotate-90 h-20 w-20 bg-no-repeat rounded-full bg-center bg-cover mx-auto block"
                        style="background-image: url('/img/me.jpg')"
                    ></div>
                    <router-link
                        to="/"
                ...
                <div
                    class="w-1/3 opacity-60 bg-gray-800 transition duration-150"
        ...
        >
            <div v-for="(crumb, i) of breadcrumbs" class="inline" :key="crumb.url">
                <router-link
                    ...
                    :class="{
                        'text-purple-500 dark:text-purple-300': i === breadcrumbs.length - 1,
                        'text-gray-600 dark:text-gray-200': i !== breadcrumbs.length - 1
                    }"
                    :to="crumb.url"
                    >/{{ crumb.name }}
                </router-link>
            ...
            <div
                class="fixed left-1/6 w-5/6 -bottom-2 pb-4 pt-1 lg:py-2 px-2 bg-gray-300 dark:bg-gray-700 transition duration-150"
            >
                <p class="lg:float-left dark:text-white lg:mt-5 transition duration-150">
                    © 2021 Morgan Dean
                </p>
