    ...
    <div>
        <div class="py-3">
            ...
            <ul class="list-disc list-inside text-gray-500 ml-2 transition duration-150">
                ...
                <li>
                    <a href="https://github.com/mdean808/audial" target="_blank">audial</a>
                    <div class="pl-10 text-gray-700 transition duration-150"><p>Hopping on the <a href="https://www.nytimes.com/games/wordle/index.html" target="_blank">wordle</a> trend, this is a web app for guessing a daily song from a given spotify playlist.</p>
                        <span class="uppercase text-gray-500 dark:text-gray-400 text-xs font-bold tracking-wider transition duration-150">svelte, typescript, tailwindcss, firebase, node.js</span>
                    </div>
                </li>
                <li>
